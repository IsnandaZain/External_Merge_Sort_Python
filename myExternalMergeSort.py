...
def mergeSortedFile(filename_list, size):
    sorted_output = []
    filehandler = []
    tmp_sorted = []
    filename = ""
    ...
    while len(sorted_output) < (size+1):
        if i < 10:
            ...
            """ Data sudah tersorting dan sudah ditambahkan """
...
final_sorted = mergeSortedFile(filename_list, len(data))
print(final_sorted)